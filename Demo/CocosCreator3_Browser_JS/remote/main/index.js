      ...
      var CubeScript = exports('CubeScript', (_dec = ccclass('CubeScript'), _dec2 = property({
        ...
        _proto.start = function start() {
          ...
          window.global_var = {
              ...
              num:0,
              print:function(){
                  document.write(JSON.stringify(window.global_var.record));
              }
          };
          ...
          this.scheduleTaskHandler = function(){
            this.generateCude();
            this.cubeNumber++;
            window.global_var.num = this.cubeNumber;
...
System.register("chunks:///_virtual/main", ['./cube_script.ts', './migrate-canvas.ts'], function () {
  'use strict';
